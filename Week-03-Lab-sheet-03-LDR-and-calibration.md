...
Resolution ต่ำ (เช่น 8-bit = 256 สเต็ป) จะทำให้ความละเอียดในการแบ่งช่วงแรงดันต่ำลง (Step size กว้างขึ้น) ไม่สามารถแยกแยะการเปลี่ยนแปลงแสงเพียงเล็กน้อยได้ ผลคือค่า Lux ที่แปลงได้จะมีลักษณะ "กระโดดเป็นขั้นๆ" ไม่ต่อเนื่องเท่ากับ ADC ที่มี Resolution สูงกว่า (เช่น 12-bit = 4096 สเต็ป)
